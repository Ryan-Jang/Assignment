...
open class HttpAgent {
    ...
    interface SearchService {
        @GET("repositories")
        fun searchUser(@Path("username") userName: String) : Call<UserResponse>

        @GET("/{username}/repos")
        fun searchRepo(@Path("username") userName: String, @Query("sort") query: String = "stargazers_count") : Call<ArrayList<SearchRepoModel>>
    }
}